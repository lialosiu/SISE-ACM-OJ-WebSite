...
<div>
    <div id="login-block">
        ...
        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('api/login'); ?>">
            ...
            <div class="form-group">
                <label for="inputPassword" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">密码</label>
            ...
            <div class="form-group">
                <div class="col-xs-offset-2 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-lg-10">
