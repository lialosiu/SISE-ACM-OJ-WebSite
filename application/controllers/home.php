...
class Home extends CI_Controller
{
    ...
    public function listAnswerByUserID($UserID = 0, $Page = 1, $Limit = _DefaultRowLimit_)
    {
        ...
        $thatAnswerList = AnswerManager::getAnswerListByUserID($UserID, $Page, $Limit);

        $this->load->library('pagination');
        $this->pagination->initialize([
            'base_url'    => base_url('home/listAnswerByUserID/' . $UserID),
            'total_rows'  => $thatAnswerList->getCountWithFilter(),
            'per_page'    => $Limit,
            'uri_segment' => 4
        ]);
